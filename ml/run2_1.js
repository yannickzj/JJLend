...
module.exports = function(callback) {
    ...
    Promise.all([p1, p2, p3]).then(function() {
        ...
        return coltoken.approve(jjlend.address, coltokenIndex, {from: account2});
    }).then(function(){
        ...
        return jjlend.postBorrowRequest(10, 15, 600, coltokenIndex, {from: account2});
    }).then(function(){
        return jjlend.getUserRequest(account2, 'waitingForLender', {from: account0});
        ...
        console.log(details);
        console.log("stage 3");
        return jjcoin.approve(jjlend.address, 10, {from: account1});
    }).then(function() {
        console.log("request addr " + requestAddr);
        return jjlend.acceptBorrowRequest(requestAddr, {from: account1});
    }).then(function(){
        return jjlend.getUserRequest(account2, 'waitingForPayback', {from: account0});
    }).then(function(result){
        ...
        console.log("balance acc2: " + account2 + " " + balance);
        console.log("stage 4");
        return jjcoin.approve(jjlend.address, 15, {from: account2});
    }).then(function(){
        return jjlend.paybackLoan(requestAddr, {from: account2});
    }).then(function(){
        return jjlend.getUserRequest(account2, 'closed', {from: account0});
    }).then(function(result){
        var len = result.length;
        var addr = result[len - 1];
