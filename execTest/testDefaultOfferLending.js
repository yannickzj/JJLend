...
module.exports = function(callback) {
    ...
    return JJCoinContract.new().then(function (instance) {
        ...
        console.info("Default offer lending");
        console.info("============================================================");
        ...
        console.info("Step 5: loan default");
        return jjLendOffer.defaultLoan(lendOfferID, {from: someone});
    }).then(function () {
        ...
        console.info("collateral[" + colID2 + "] returned to lender: " + (val == lender));
